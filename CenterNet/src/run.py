...
PATH_DETECTION_INFO = '/content/HCMCAIC/detection_info/'

def demo(opt):
    class_map = {1: 0, 2: 1, 3: 2, 4: 3} # color for boundingbox
    ...
    for video_path in sorted(video_paths):
        ...
        #    filename='/content/drive/My Drive/Shared/HCMCAIC/detection_results/{}_'.format(opt.arch) + os.path.basename(video_path),
        ...
        with open(PATH_DETECTION_INFO + os.path.basename(video_path) + '.pkl', 'wb') as f:
